...
EZUI_Page Page_BlinkProgram;
EZUI_Control_Label Lbl_Notification("Blink Program Page!");
EZUI_Control_ToggleOption Tgl_EnableProgram("Run/Stop:", &BlinkEnabled, "Run", "Stop");
EZUI_Control_Label Lbl_EnableProgramStatus(&BlinkEnabled, "Run", "Stop");
EZUI_Control_AdjustParam Adj_BlinkFrequency("Frequency:", &BlinkFrequency);
EZUI_Control_Label Lbl_BlinkFrequencyValue(&BlinkFrequency);

//Group the Menu Controls into an array
EZUI_PageItems Page_BlinkProgram_Items[] {
    { 0,0,20,&Lbl_Notification},
    { 2,1,9,&Tgl_EnableProgram},
    {12,1,5,&Lbl_EnableProgramStatus},
    { 1,2,10,&Adj_BlinkFrequency},
    {12,2,1,&Lbl_BlinkFrequencyValue}
};
...
void setup() {
  ...
  Page_BlinkProgram.setItems(A(Page_BlinkProgram_Items));

  //Set the Display to show the Menu
  UI.setDisplay(&Page_BlinkProgram);
